...
export const PUT = async (req: any) => {
    ...
    try {
        ...
        const existingReaction = await reactionsCollection.findOne({ hash: sha256Hash, action: "like", comment_id: ObjectId.isValid(commentId) ? new ObjectId(commentId) : commentId 
    });
